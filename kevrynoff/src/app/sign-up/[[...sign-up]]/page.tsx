       ...
       <div className="relative z-10 p-1 rounded-[2.5rem] bg-gradient-to-br from-brand/20 via-white/5 to-transparent shadow-[0_0_80px_rgba(var(--color-brand-rgb),0.1)]">
         <div className="p-8 pb-12 rounded-[2.4rem] bg-background/80 backdrop-blur-3xl border border-white/5">
             <div className="text-center mb-8">
               <div className="text-[10px] font-black text-brand uppercase tracking-[0.4em] mb-2">Initialize Identity</div>
               <h1 className="text-3xl font-black text-white uppercase tracking-tighter">Sovereign Intel</h1>
             </div>
             ...
             <SignUp 
               appearance={{
                 elements: {
                   rootBox: 'mx-auto',
                   card: 'bg-transparent shadow-none w-full max-w-sm',
                   headerTitle: 'hidden',
